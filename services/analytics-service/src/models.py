...
class SummaryResponse(BaseModel):
    ...
    total_confirmed_shifts: int
    total_workers_active_30d: int
    platforms_tracked: List[str]
    highest_deduction_rate: dict
    lowest_deduction_rate: dict
    most_complained_platform: str
    vulnerability_flag_count: int
    views_last_refreshed_at: datetime
